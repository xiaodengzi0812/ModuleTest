...
import com.dengzi.moduletest.span.BlurMaskFilterSpan;
import com.dengzi.moduletest.span.ForegroundAlphaColorSpan;
import com.dengzi.moduletest.span.ForegroundAlphaColorSpanGroup;
import com.dengzi.moduletest.span.ShadowSpan;
    ...
    public void initView(Bundle savedInstanceState, View view) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ToastUtils.show("事件触发了", Toast.LENGTH_SHORT);
            }
        ...
        tvAboutSpan.setText(new SpanUtils()
                ...
                .append("测试").appendLine("Url").setUrl("https://github.com.dengzi.moduletest.utiltest")
