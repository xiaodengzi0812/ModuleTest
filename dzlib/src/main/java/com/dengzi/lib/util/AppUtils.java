...
public final class AppUtils {
    ...
    public static void installApp(final File file, final String authority) {
        ...
        DZUtil.getContext().startActivity(IntentUtils.getInstallAppIntent(file, authority));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        DZUtil.getContext().startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        DZUtil.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return DZUtil.getContext().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(DZUtil.getContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        if (isSpace(packageName)) return;
        DZUtil.getContext().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(DZUtil.getContext().getPackageName());
    }
    ...
    public static String getAppName(final String packageName) {
        ...
        try {
            PackageManager pm = DZUtil.getContext().getPackageManager();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(DZUtil.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(DZUtil.getContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(DZUtil.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(DZUtil.getContext().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(DZUtil.getContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(DZUtil.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(DZUtil.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(DZUtil.getContext().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) DZUtil.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(DZUtil.getContext().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(DZUtil.getContext().getPackageName());
    }
